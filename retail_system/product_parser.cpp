...
{
    Product* mybook = new Book(categoryID(), prodName_, price_, qty_, isbn_, author_);
...
{
    Product* myclothes = new Clothing(categoryID(), prodName_, price_, qty_, size_, brand_);
...
{
    Product* mymovie = new Movie(categoryID(), prodName_, price_, qty_, genre_, rating_);
